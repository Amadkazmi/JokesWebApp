...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> ShowSearchResults(string SearchPhrase)
        {
            ...
            .ToListAsync());//j=j means we just want to show the result what its been search nothing else
        }


        /*public string ShowSearchResults(string SearchPhrase)// fx Becoz we return just return string
        {
        ...
        // GET: Jokes/Create //login form validation
        [Authorize]
